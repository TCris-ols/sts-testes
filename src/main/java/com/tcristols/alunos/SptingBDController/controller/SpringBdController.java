package com.tcristols.alunos.SptingBDController.controller;
...
import com.tcristols.alunos.SptingBDController.service.AlunoService;
...
public class SpringBdController {
	...
	public String submitDelete(@Validated @ModelAttribute("aluno") Aluno aluno, BindingResult result, ModelMap model) {
